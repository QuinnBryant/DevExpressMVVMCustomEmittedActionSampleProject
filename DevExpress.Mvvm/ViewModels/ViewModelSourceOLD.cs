...
namespace DevExpress.Mvvm.POCO {
    ...
    public class ViewModelSource {
        ...
        public static T Create<T>(Action<object, object, object, string> customChangedMethod = null) where T : class, new() {
            return Factory(() => new T(), customChangedMethod)();
        }
        public static T Create<T>(Expression<Func<T>> constructorExpression) where T : class {
            ...
            var actualAxpression = GetCtorExpression(constructorExpression, typeof(T), false, null);
            return Expression.Lambda<Func<T>>(actualAxpression).Compile()();
        }
        #region GetFactory
        public static Func<TResult> Factory<TResult>(Expression<Func<TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, TResult> Factory<T1, TResult>(Expression<Func<T1, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, TResult> Factory<T1, T2, TResult>(Expression<Func<T1, T2, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, TResult> Factory<T1, T2, T3, TResult>(Expression<Func<T1, T2, T3, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, T4, TResult> Factory<T1, T2, T3, T4, TResult>(Expression<Func<T1, T2, T3, T4, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, T4, T5, TResult> Factory<T1, T2, T3, T4, T5, TResult>(Expression<Func<T1, T2, T3, T4, T5, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, T4, T5, T6, TResult> Factory<T1, T2, T3, T4, T5, T6, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, T4, T5, T6, T7, TResult> Factory<T1, T2, T3, T4, T5, T6, T7, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult> Factory<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> Factory<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> Factory<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>> constructorExpression, Action<object, object, object, string> customChangedMethod = null) where TResult : class {
            return GetFactoryCore(constructorExpression, typeof(TResult), customChangedMethod);
        }
        #endregion

        #region helpers
        static TDelegate GetFactoryCore<TDelegate>(Expression<TDelegate> constructorExpression, Type resultType, Action<object, object, object, string> customChangedMethod) {
            ValidateCtorExpression(constructorExpression, true);
            return GetFactoryCore<TDelegate>(() => CreateFactory(constructorExpression, resultType, customChangedMethod));
        }
        ...
        static TDelegate CreateFactory<TDelegate>(Expression<TDelegate> constructorExpression, Type resultType, Action<object, object, object, string> customChangedMethod) {
            var actualAxpression = GetCtorExpression(constructorExpression, resultType, true, customChangedMethod);
        ...
        static Expression GetCtorExpression(LambdaExpression constructorExpression, Type resultType, bool useOnlyParameters, Action<object, object, object, string> customChangedMethod) {
            Type type = GetPOCOType(resultType, customChangedMethod);
            NewExpression newExpression = constructorExpression.Body as NewExpression;
            if(newExpression != null) {
        ...
        public static Type GetPOCOType(Type type, Action<object, object, object, string> customChangedMethod, ViewModelSourceBuilderBase builder = null)
        {
            Func<Type> createType = () => CreateType(type, builder, customChangedMethod);
            if (builder == null) builder = ViewModelSourceBuilderBase.Default;
            return builder == ViewModelSourceBuilderBase.Default ? Types.GetOrAdd(type, createType) : createType();
        }
        ...
        #endregion
        static Type CreateType(Type type, ViewModelSourceBuilderBase builder, Action<object, object, object, string> customChangedMethod = null) {
            CheckType(type, true);
            ...
            builder.BuildBindableProperties(type, typeBuilder, raisePropertyChanged, raisePropertyChanging, customChangedMethod);
    ...
    public class ViewModelSourceBuilderBase {
        ...
        public void BuildBindableProperties(Type type, TypeBuilder typeBuilder, MethodInfo raisePropertyChangedMethod, MethodInfo raisePropertyChangingMethod, Action<object, object, object, string> customChangedMethod) {
            ...
            foreach(var propertyInfo in bindableProps) {
                var newProperty = BuilderBindableProperty.BuildBindableProperty(type, typeBuilder,
                    propertyInfo, raisePropertyChangedMethod, raisePropertyChangingMethod, customChangedMethod,
    ...
    static class BuilderBindableProperty {
        public static PropertyBuilder BuildBindableProperty(Type type, TypeBuilder typeBuilder, PropertyInfo propertyInfo,
            MethodInfo raisePropertyChangedMethod, MethodInfo raisePropertyChangingMethod, Action<object, object, object, string> customChangedMethod, IEnumerable<string> relatedProperties) {
        ...
        static MethodBuilder BuildBindablePropertySetter(TypeBuilder type, PropertyInfo property, MethodInfo raisePropertyChangedMethod, MethodInfo raisePropertyChangingMethod, MethodInfo propertyChangedMethod, MethodInfo propertyChangingMethod, Action<object, object, object, string> customChangedMethod, IEnumerable<string> relatedProperties, bool onChangedFirst) {
            ...
            if (customChangedMethod != null)
            {
                EmitCustomChangedMethod(gen, customChangedMethod, property.Name, shouldBoxValues, property);
            }
